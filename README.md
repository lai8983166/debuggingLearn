...
| # | 关卡 | 训练的能力 | 难度 | 前置 |
| --- | --- | --- | --- | --- |
| 23 | 谁在重渲染 | React DevTools | ★★☆ | 22 |
| 24 | 录制与回放 | Recorder | ★★☆ | 23 |
| 25 | 层爆炸 | Layers / GPU 合成 | ★★☆ | 24 |
| 26 | 三大浏览器 | 跨浏览器 DevTools | ★★☆ | 25 |
| 27 | 真机调试 | chrome://inspect 等 | ★★☆ | 26 |
| 28 | AI 协作调试（结业） | AI 调试 prompt | ★★☆ | 27 |

> **v2 推荐 Chrome 或 Edge**（Safari/Firefox 对部分进阶面板支持有限）
> **Lighthouse 关需要联网**（外链 picsum 图片）
> **v3 结业关（22）综合训练**——一个仪表盘同时埋 5 个混合 bug，学员自己挑面板诊断
> **v4 的 23 关需要装 React DevTools 扩展**；24 关 Recorder 需 Chrome 117+
